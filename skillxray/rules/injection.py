...
_PATTERNS = [
    ...
    (re.compile(r"\b(?:reveal|print|show|repeat|output|disclose|leak|dump)\s+(?:your|the|his|her|its)\s+(?:system\s+prompt|initial\s+instructions|instructions|prompt)\b", _I),
